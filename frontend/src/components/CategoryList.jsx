...
const CategoryList = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex items-center gap-[10px] md:gap-5 justify-between overflow-scroll scrollbar-none">
        {loading
          ? categoryLoadingArray.map((el, i) => {
              return (
                ...
                >
                  <div className="h-16 w-16 md:w-20 md:h-20 p-4 rounded-full overflow-hidden bg-slate-200 animate-pulse flex items-center justify-center"></div>
                </div>
              );
            })
